...
if (isset($_POST['atualizar'])) {
   ...
   $resumo = $_POST['resumo'];
    ...
    /* Lógica/Algoritimo para a imagem */

    /* Se o campo imagem estiver vazio, então significa que o usuario NÃO QUER TROCAR A IMAGEM. 
    Ou seja, o sistema vai manter a imagem existente.*/
    if ( empty($_FILES['imagem']['name']) ) {
      $imagem = $_POST['imagem-existente'];
    } else {
        /* Caso contrário, então pegamos a referencia de novo arquivo (nome e extensão) e fazemos o processo de upload. */
