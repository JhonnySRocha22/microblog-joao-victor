...
/* Esta verificação será aplicada em TODAS AS PÁGINAS relacionadas oa gerenciamento de usuários da área administrativa. */
function verificaTipo(){
    /* Se o tipo de usuario logado na sessão NÃO FOR adimn */
